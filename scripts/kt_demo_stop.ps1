...
pkill -TERM -f 'python3 .*kt_mjpeg_bridge.py' 2>/dev/null || true;
pkill -KILL -f 'python3 .*kt_mjpeg_bridge.py' 2>/dev/null || true;
...
echo '--- follow_v4 tmux ---'
tmux has-session -t follow_v4 2>/dev/null && echo 'follow_v4: running' || echo 'follow_v4: stopped'
